        ...
        <nav className="fixed top-0 left-0 right-0 h-16 border-b border-white/5 bg-zinc-950/80 backdrop-blur-md z-50 flex items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4">
            ...
            {isAdminUnlocked ? (
              ...
              /* On display view when not logged in — show nothing */
              null
            ) : (
              /* On control/setup/history when not logged in — show login form */
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => void selectServiceType(e.target.value)}
